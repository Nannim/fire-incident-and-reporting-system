    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <button wire:click="create()"
                class="bg-red-700 text-white font-bold py-2 px-4 rounded my-3">Report a Fire Incident</button>
            @if($isModalOpen)
            @include('livewire.create-report')
            @endif
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            <button wire:click="edit({{ $report->id }})"
                                class="bg-yellow-500  text-white font-bold py-2 px-4 rounded">Edit</button>
