                    ...
                    <div class="">
                        <div class="mb-4">
                            ...
                            <input type="text"
                                ...
                                id="exampleFormControlInput1" placeholder="What is the level of damage?" wire:model="level">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="exampleFormControlInput2" wire:model="location"
                                placeholder="Where is it?"></textarea>
